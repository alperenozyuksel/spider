...
class Agent:
    ...
    def save_all_models(self):
        ...
        # for ddpg 
            ...
            self.DDPG_Actor.save_weights(self.DDPG_Actor.checkpoint_path + ".weights.h5")
            self.DDPG_Target_Actor.save_weights(self.DDPG_Target_Actor.checkpoint_path + ".weights.h5")
            self.DDPG_Critic.save_weights(self.DDPG_Critic.checkpoint_path + ".weights.h5")
            self.DDPG_Target_Critic.save_weights(self.DDPG_Target_Critic.checkpoint_path + ".weights.h5")
